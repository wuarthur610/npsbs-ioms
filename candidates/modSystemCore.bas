...
Public Sub EnsureProductionSheets()
    ...
    EnsureSheet "Card_Usage_Detail", Array("UsageDetailID", "TreatmentRecordID", "CardID", "CustomerID", "UsageDate", "SessionsUsed", "UsageType", "ShortageSessions", "Notes", "CreatedAt", "CreatedBy", "Version")
